...
(function( $ ){
    ...
    methods: {
      init : function( options ) {
        ...
        return this.each(function(){
          ...
          if (!$helpBlock.length && settings.options.autoAdd && settings.options.autoAdd.helpBlocks) {
              $helpBlock = $('<div class="help-block" style="display:none;"/>');
              $controlGroup.find('.input-block').append($helpBlock);
      ...
      /*createAccessibleAlert: function(errorList) {
        $('#all-error-messages').removeClass('access-hide');
        $('#all-error-messages').attr('role', 'alert');
        $('#error-message-intro').html('We found some errors on the form. Please review the following list:');
        $('#message-list').append(errorList);
      },*/
      destroy : function( ) {
        ...
        validate: function ($this, value, validator) {
          ...
          return false;
			...
			regex: {
				...
				validate: function ($this, value, validator) {
					return (value.length !== 0 && !validator.regex.test(value) && ! validator.negative)
						|| (value.length !== 0 && validator.regex.test(value) && validator.negative);
				}
			},
			required: {
				name: "required",
